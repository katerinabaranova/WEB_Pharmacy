...
<form class="form-horizontal">
    <fieldset>
        <legend>Adding new medicine</legend>
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <input id="packQuantity" name="packQuantity" placeholder="" class="form-control input-md" required="" type="text">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                <input id="instoreQuantity" name="instoreQuantity" placeholder="" class="form-control input-md" required="" type="text">
